...
//CC any request coming with prefix of /images goes here.
// app.use('/images',isAuthenticated, express.static(path.join(__dirname, 'images')));
//CC securing public routes
